...
export default function PopularProducts() {
    return (
        <div className="bg-white px-4 pt-3 pb-4 rounded-sm border border-gray-200 w-[22rem]">
            <strong className="text-gray-700 font-medium">Popular Products</strong>
            <div className="mt-4 flex flex-col gap-3">
                {popularProductsData.map((product) => (
                    <Link key={product.id} to={'/product/${product.id}'} className="flex">
                        ...
                        <div className="ml-4 flex-1">
                            ...
                            <span
                                className={
                                    'text-sm font-medium ${product.product_stock === 0 ? "text-orange-500" : "text-green-400"}'
                                }
                            >
